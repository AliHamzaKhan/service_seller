...
class ServiceCardDesign extends StatelessWidget {
  ServiceCardDesign({Key? key}) : super(key: key);
  MyService? myService;
  @override
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Text("Service name", style: TextStyle(color: colorSecondary, fontSize: 15),),
               ...
               Expanded(flex : 1 ,child: Container(
                 ...
                 child: Column(
                   ...
                   children: [
                     ...
                     Text("al rahim ac service", style: TextStyle(color: textColor, fontSize: 18, fontWeight: FontWeight.bold,),maxLines: 1, overflow: TextOverflow.fade,),
                     SizedBox(height: 5),
                     Row(
                       children: [
                         ClipRRect(
                           borderRadius: BorderRadius.circular(30),
                           child: Image.asset("assets/images/get_started_background_one.jpg", fit: BoxFit.cover, width: 50, height: 50,),
                         ),
                         SizedBox(width: 10),
                         Text("User name", style: TextStyle(color: textColor, fontSize: 13),)
                       ],
                     )
                   ],
                 ),
