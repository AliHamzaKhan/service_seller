                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration: InputDecoration(
                        hintText:
                            "Example: you will need to bring a gate pass, I will not be home and am leaving the key under the mat, etc.",
                        hintStyle: TextStyle(
                            color: colorPrimary.withOpacity(0.7), fontSize: 18),
                        labelStyle: TextStyle(
                            color: colorPrimary.withOpacity(0.7), fontSize: 18),
                        focusedBorder: OutlineInputBorder(
                          borderSide:
                              BorderSide(color: colorDarkGrey, width: 1),
                        ),
